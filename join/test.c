...
int main() {
    ...
    run_disk_block_nested_loop_join_test(customer_file, order_file, 50);
    run_disk_block_nested_loop_join_test(customer_file, order_file, 10);

    run_disk_nested_loop_join_test(customer_file, order_file);
